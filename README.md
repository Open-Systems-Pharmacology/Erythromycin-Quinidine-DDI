...
Modeling of published erythromycin-quinidine-DDI studies for model evaluation

## Repository files
Within this repository, we distribute a PK-Sim snapshot containing simulations of all published clinical studies used to evaluate the predictive performance of the erythromycin and quinidine models regarding erythromycin-quinidine-DDIs, including the respective observed data digitized from literature reports. The applied quinidine model has been published previously [1].
